...
"""
    This file is modified from 1D ResNet implementation on
    https://github.com/hsd1503/resnet1d. Please also consider cite the original
    authors if you use this code.
"""
